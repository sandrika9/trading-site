...
# Supabase PostgreSQL ბაზის მისამართი (სწორი კოდირებით)
DATABASE_URL = os.environ.get(
    "DATABASE_URL", 
    "postgresql://postgres.rnktcgfknokfdktfxjkb:Sandrika789%24%40aws-0-ap-northeast-2.pooler.supabase.com:6543/postgres"
)
